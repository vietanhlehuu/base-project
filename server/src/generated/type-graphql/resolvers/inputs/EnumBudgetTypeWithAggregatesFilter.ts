...
import { NestedEnumBudgetTypeWithAggregatesFilter } from "../inputs/NestedEnumBudgetTypeWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { BudgetType } from "../../enums/BudgetType";

@TypeGraphQL.InputType("EnumBudgetTypeWithAggregatesFilter", {
  isAbstract: true
})
export class EnumBudgetTypeWithAggregatesFilter {
